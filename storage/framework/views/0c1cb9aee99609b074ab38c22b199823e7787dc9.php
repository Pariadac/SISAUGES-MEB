    ...
    <?php if(Auth::guest()): ?><div id="wrapper" ><?php else: ?> <div id="wrapper"> <?php endif; ?>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <?php if(Auth::guest()): ?> Usuario <?php else: ?> <?php echo e(Auth::user()->username); ?> <?php endif; ?><b class="caret"></b></a>
                ...
                <?php if(Auth::guest()): ?><ul class="nav navbar-nav side-nav" id="eltraslado"><?php else: ?> <ul class="nav navbar-nav side-nav" id="eltraslado"> <?php endif; ?>
                    ...
                    <li>
                        ...
                        <ul id="field-dep" class="collapse">
                            ...
                            <li>
                                <a href="<?php echo e(url('/departamento/crear')); ?>">AGREGAR</a>
                            </li>
                            <li>
                                <a href="<?php echo e(url('/departamento')); ?>">LISTAR</a>
                            </li>
